...
function generate_faqpage_schema() {
   ...
   // Verifica si 'bloques_flexibles' está definido y es un array
   if ($fields && isset($fields['bloques_flexibles']) && is_array($fields['bloques_flexibles'])) {
      foreach ($fields['bloques_flexibles'] as $block) {
